...
// Image management
let imageCount = 0;
const maxImages = 12; // Allow for wrapping
let uploadedImages = [];
...
function initializeImageGrid() {
    ...
    // Create just one initial placeholder slot
...
// Handle camera input - optimized for single photo capture
document.getElementById('cameraInput').addEventListener('change', function(e) {
    const file = e.target.files[0]; // Take only the first file for single photo mode
...
function continueToNext() {
    // For development: Skip validation and proceed
    alert('Moving to next section...');
    ...
    if (form.checkValidity()) {
        ...
        alert('Moving to next section...');
        // Here you would submit the form data and navigate to the next section
    } else {
        form.reportValidity();
    }
    */
